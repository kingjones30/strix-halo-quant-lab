...
**Running large language models locally on AMD Ryzen AI Max+ 395 (Strix Halo) with ROCmFP4 4-bit quantization — measured benchmarks, build recipes, and 143 ready-to-run GGUF models.**
...
**143 repositories** — 131 ROCmFP4/ROCmFPX for AMD Strix Halo, 9 NVFP4 for NVIDIA, 3 other. **180,872 downloads** in the last 30 days.
